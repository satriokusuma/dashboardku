...
Highcharts.setOptions({
  ...
  var Total = 0;
  var chart_rms_outlet = new Highcharts.chart({
        chart: {
            renderTo: 'chart-rms-outlet',
            backgroundColor: null,
            plotBackgroundColor: null,
            plotBorderWidth: null,
            plotShadow: false,
       ...
       legend: {
            ...
            labelFormatter: function() {
                Total += this.y;
                return '<div><span style="color:#fff;">'+ this.name +' : '+'</span><span style="color:#fff;font-weight: 700;">' + this.y + '</span></div>';
            },
            itemStyle: {
                fontSize: '11px',
                fontWeight: 300,
...
Highcharts.setOptions({
  ...
  var Total = 0;
  var chart_ifs_outlet = new Highcharts.chart({
        chart: {
            renderTo: 'chart-ifs-outlet',
            backgroundColor: null,
            plotBackgroundColor: null,
            plotBorderWidth: null,
            plotShadow: false,
