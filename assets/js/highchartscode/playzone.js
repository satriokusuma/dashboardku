  ...
  var chart_pie_playzone = new Highcharts.chart({
       ...
       legend: {
            ...
            labelFormatter: function() {
                Total += this.y;
                return '<div><span style="font-weight:bold">'+ this.name +' : '+'Rp.'+'</span><span style="font-weight:bold">'+ this.y +'</span></div>';
            },
            itemStyle: {
                fontSize: '11px',
                fontWeight: 300,
...
var chart_bar_playzone = new Highcharts.chart({
    ...
    xAxis: {
        categories:['R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG', 'R75 SERANG','R75 SERANG'],
        labels: {
        style: {
        fontSize: '12px',
        color: '#43425D',    
